...
SKlauncher currently doesn't have an installer for any of the OS.
...
## Common questions
Some users may have some questions before or after downloading, we'll counter the FAQ's here:
...
It can be said that it's to simplify things for Windows users who are not in Computer Field.
...
## Common issues
Some users may find that they are unable to download SKlauncher, here are some common issues and a tutorial to fix them in most of the cases.
...
This may happen if you're using a download manager, Please disable it and try again it should be work like butter.
